...
namespace ECommerce.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public async Task<Response<NoContent>> Delete(int id)
        {
            ...
            return status > 0 ? Response<NoContent>.Success(200) : Response<NoContent>.Fail("Discount Not Deleted", 500);
        }
        ...
        public async Task<Response<DiscountDto>> GetById(int id)
        {
            ...
            return discount != null ? Response<DiscountDto>.Success(_mapper.Map<DiscountDto>(discount), 204) : Response<DiscountDto>.Fail("Discount not found", 404);
        }
